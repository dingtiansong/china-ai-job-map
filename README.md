...
本项目所有评分均基于大模型生成，无任何实际调研基础，亦不构成任何建议和意见。
...
![首页 / 职业影响地图](assets/screenshot-home.png)

### 榜单

![榜单视图](assets/screenshot-ranking.png)

### 职业对比

![职业对比雷达图](assets/screenshot-compare.png)
...
凡引用、转载、摘录或以本项目为基础做二次发布（含截图、榜单、指数、标签、导出卡片等），**须同时说明来源**，至少包括：

- **项目名称**：中国职业 AI 影响全景图（China AI Job Map）
- **可核验链接**：[在线演示](https://dingtiansong.github.io/china-ai-job-map/) 与/或 [源码仓库](https://github.com/dingtiansong/china-ai-job-map) ，并建议注明访问或数据批次日期
- **性质区分**：本仓库中的大模型评分与解释文案属于项目加工结果，**不得**仅标注为《职业分类大典》或任何官方统计口吻；职业分类底座与模型评分应**分开署名**，避免误导读者将本项目输出等同于官方发布

学术论文、新闻报道或内部材料中的引用，请按贵方机构要求的引用格式写明上述来源与检索信息。
